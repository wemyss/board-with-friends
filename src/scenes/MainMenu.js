...
export default class MainMenu extends Phaser.Scene {
	...
	create() {
		...
		const highScoreButton = addButton(this, 400, 540, 'button', 'blank-button', highScoreCallback, {frameDown:'blank-button-clicked', text:'High Scores'})
		highScoreButton.setScale(2/3, 1/2)
	}
